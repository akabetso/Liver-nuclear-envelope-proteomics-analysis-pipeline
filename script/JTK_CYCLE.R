...
jtk.init <- function(periods, interval=1) {
  ...
  for(i in 1:length(periods)) {
    ...
    # print(paste("length(cos.s):", length(cos.s)))
    # print(paste("length(tim[range]):", length(tim[range])))
    # print(paste("cos.s:", paste(cos.s, collapse=", ")))
    # print(paste("tim[range]:", paste(tim[range], collapse=", ")))
  }
}
